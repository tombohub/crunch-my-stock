...
namespace Crunch.DataSources.Fmp.HistoricalPricesEndpoint
{
    ...
    internal class HistoricalPricesRequester
    {
        ...
        /// <returns></returns>
        public DailyPriceSet RequestData(string symbol, Period timeRange, PriceInterval interval)
        {
        ...
        private string CreateQueryString(string symbol, Period timeRange, PriceInterval interval)
        {
